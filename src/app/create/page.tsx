...
// ─── Normal mode page (original behavior) ───

function NormalCreatePage() {
...
// ─── Demo mode page (inline generation & preview) ───
...
export default function CreatePage() {
  if (isDemoMode) {
    return <DemoCreatePage />;
  }
  return <NormalCreatePage />;
}
